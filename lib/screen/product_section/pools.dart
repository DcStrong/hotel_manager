...
class _PoolsSectionState extends State<PoolsSection> {
  Widget buildContent() {
    return FutureBuilder(
      initialData: [],
      future: ApiRouter.getSectionPoolForHome(context),
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return ScreenProduct(title: 'Бассейны',path: 'pools');
                  }));
                },
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text('Бассейны', style: Theme.of(context).textTheme.headline1,),
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (ctx, i) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(context, MaterialPageRoute(builder: (context) {
                          return DetailCard(id: snapshot.data![i].id, path: 'pools',);
                        }));
                      },
